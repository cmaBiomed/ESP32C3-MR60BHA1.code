...
// I want to free the serial port for more uart comunication so this has to go
// Beacause its a void function i am just going to comment everithing it does 
// and leave the rest of the file untouched
